...
Odisha,India</p>
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p>As a team, our mission is not only to create websites but also to foster growth and innovation within our community.</p>
                        <div class="position-relative w-100 mt-3">
                            <!-- <form id="contactForm">
                            <input class="form-control border-0 rounded-pill w-100 ps-4 pe-5" type="email" placeholder="Your Email" style="height: 48px;">
